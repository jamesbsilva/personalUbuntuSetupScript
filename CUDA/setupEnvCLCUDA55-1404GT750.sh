...
echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
sudo ln -s /usr/lib/nvidia-337/libcuda.so.1 /usr/lib/libcuda.so.1
sudo ln -s /usr/lib/nvidia-337/libcuda.so /usr/lib/libcuda.so
sudo ln -s /usr/lib/nvidia-337/libOpenCL.so /usr/lib/libOpenCL.so
sudo ln -s /usr/lib/nvidia-337/libOpenCL.so.1 /usr/lib/libOpenCL.so.1
...
echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
sudo ln -s /usr/share/nvidia-337/nvidia.icd /etc/OpenCL/vendors/nvidia.icd 
sudo ln -sf /usr/lib/nvidia-337/libOpenCL.so /usr/lib/
echo "~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~"
